abstract class PaymentImages {
  ...
  static const String stripe = "assets/stripe.png";
  static const String fedapay = "assets/fedapay.jpeg";
  static const String paypalButtonIcon = "assets/paypal-button-icon.png";
}
