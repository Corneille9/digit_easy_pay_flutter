...
import 'package:digit_easy_pay_flutter/src/ui/widgets/select_form_field.dart';
...
class CustomTextField extends StatelessWidget {
  const CustomTextField({
    ...
    this.onTap,
    this.border,
    this.intlPhoneField = false,
    this.autofocus,
    this.labelFontSize,
    this.onCreate,
    this.selectFormField = false,
    this.items,
    this.borderColor,
    this.fontSize,
    this.contentPadding,
  ...
  Widget? get _prefixIcon =>
      (prefixIcon == null) ? null : Padding(padding: const EdgeInsets.all(15.0), child: prefixIcon);
    ...
    if (selectFormField) {
      return SelectFormField(
        ...
        decoration: InputDecoration(
          filled: true,
          isDense: isDense,
          fillColor: theme.textColor.withAlpha(10),
          hintText: hintText,
          ...
          errorBorder: _border.copyWith(
            borderSide: _border.borderSide.copyWith(color: theme.errorColor),
          ),
