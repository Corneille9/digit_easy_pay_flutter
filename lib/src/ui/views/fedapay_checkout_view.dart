...
class FedapayCheckoutView extends StatefulWidget {
  /// The payment theme
  ...
  @override
  State<FedapayCheckoutView> createState() => _FedapayCheckoutViewState();
}

class _FedapayCheckoutViewState extends State<FedapayCheckoutView> {
  /// WebView controller
  ...
  final String _successPattern = "status=approved";

  /// Cancel URL pattern to detect cancelled payments
  final String _cancelPattern = "status=canceled";
