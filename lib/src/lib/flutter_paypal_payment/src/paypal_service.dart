...
class PaypalServices {
  ...
  PaypalServices({required this.clientId, required this.secretKey, required this.sandboxMode});

  getAccessToken() async {
    String baseUrl = sandboxMode ? "https://api-m.sandbox.paypal.com" : "https://api.paypal.com";
  ...
  Future<Map> createPaypalPayment(transactions, accessToken) async {
    ...
    try {
      ...
      return {'error': true, 'message': "Payment Failed.", 'data': e.response?.data};
    } catch (e) {
      rethrow;
    }
  }
